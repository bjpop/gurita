'''
Module      : violin_plot 
Description : Create a violin plot from the data 
...
class ViolinPlot(CommandBase, name="violin"):
    description = "Show distrbution of numerical feature using violin, optionally grouped by categorical features."
    category = "plotting"
